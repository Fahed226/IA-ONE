...
- **Target audience**: consumer users; consider age group, usage context
...
Available stacks: `react`, `nextjs`, `vue`, `nuxtjs`, `nuxt-ui`, `svelte`, `astro`, `angular`, `react-native`, `flutter`, `swiftui`, `jetpack-compose`, `shadcn`, `html-tailwind`, `threejs`, `laravel`
...
- When Phosphor doesn't have the right icon, use **Heroicons (`@heroicons/react`)** as fallback.

| Rule | Standard | Avoid | Why It Matters |
|------|----------|--------|----------------|
| **No Emoji as Structural Icons** | Use vector-based icons (Phosphor, Heroicons, react-native-vector-icons) | Using emojis (🎨 🚀 ⚙️) for navigation or system controls | Emojis are font-dependent, inconsistent across platforms |
| **Vector-Only Assets** | Use SVG or platform vector icons | Raster PNG icons that blur or pixelate | Ensures scalability and dark/light mode adaptability |
...
| **Icon Contrast** | Follow WCAG contrast standards: 4.5:1 for small elements | Low-contrast icons that blend into the background | Ensures accessibility in both light and dark modes |
